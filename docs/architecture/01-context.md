...
| `get_next_task` | задача из банка или пакет, чтобы написать новую | T20 |
| `submit_task` | проверка и приём задачи, которую написала модель | T21 |
| `submit_answer` | ответ ученика, история и рейтинги | T22 |
