...
- [PRODUCT-V1.md](PRODUCT-V1.md) — product spec for MathTrail v1 (a free, open-source, stateless Go service): requirements, chat platform research, open questions. The starting point for the new repository.
