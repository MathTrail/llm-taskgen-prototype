...
- [docs/architecture/](docs/architecture/) — diagrams. Each file ends with a «Замечания к SPEC» section. Diagrams 01, 02 and 04 describe the old Claude API pipeline (see D42); 01 is redrawn in T19.
